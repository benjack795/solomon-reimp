...
-((UPPERLENGTH*bodgeno.at(0))/2)*sin(r_th_ang), 
-(HIPLENGTH/2),
startz-(HIPRADIUS/2)-(((UPPERLENGTH*bodgeno.at(0))/2)*cos(r_th_ang)));
        //set thigh rotation
        dMatrix3 rot_ptr;
...
-((UPPERLENGTH*bodgeno.at(0))/2)*sin(l_th_ang), 
(HIPLENGTH/2),
startz-(HIPRADIUS/2)-(((UPPERLENGTH*bodgeno.at(0))/2)*cos(l_th_ang)));
        //set thigh rotation
        dMatrix3 rot_ptr2;
...
kneepos_ptr[0] - ((LOWERLENGTH*bodgeno.at(0))/2)*sin(r_sh_ang) + 0.0011*cos(r_sh_ang),
kneepos_ptr[1] +0.0140,
kneepos_ptr[2]- ((LOWERLENGTH*bodgeno.at(0))/2)*cos(r_sh_ang) + 0.0011*sin(r_sh_ang));
        dMatrix3 rot_ptr3;
...
kneepos_ptr2[0] - ((LOWERLENGTH*bodgeno.at(0))/2)*sin(l_sh_ang) + 0.0011*cos(l_sh_ang),
kneepos_ptr2[1]-0.0140,
kneepos_ptr2[2]- ((LOWERLENGTH*bodgeno.at(0))/2)*cos(l_sh_ang) + 0.0011*sin(l_sh_ang));
        dMatrix3 rot_ptr4;
...
ank_ptr2[2] -(FOOTHEIGHT/2)*cos(l_an_ang));
	...
	dReal startratio = 0.1/0.33;
        ...
        dBodySetPosition (exbody[1],PEAPOS,0,SPHERERAD + (startratio*startz) + 0.05);
	...
	//EXTRA JOINTS
        ...
        dJointSetHingeAnchor (exjoint[1],PEAPOS,0,SPHERERAD + (startratio*startz) + 0.05);
